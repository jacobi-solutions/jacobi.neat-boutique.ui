...
@Component({
  ...
  templateUrl: './delete-account-init.component.html',
  styleUrls: ['../auth-flow.page.scss', './delete-account-init.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class DeleteAccountInitComponent implements OnInit {
 ...
 initDeleteAccountRequest() {
  this._authService.deleteAccountSignInWithLink().then(() => {
