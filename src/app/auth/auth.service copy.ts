...
export class AuthServiceS {
  ...
  deleteAccountInit() {
    ...
    var accountDeletion = new AccountDeletionS();
  ...
  deleteAccountFinal(accountDeletion: AccountDeletionS|null) {
  ...
  deleteAccountRollback(accountDeletion: AccountDeletionS|null) {
